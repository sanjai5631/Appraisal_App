...
namespace EAA.Domain.DTO.Response.User
{
    public class EmployeeResponse_DTO
    {
        ...
        public string? CreatedBy { get; set; }            // HR who created
        public string? ModifiedBy { get; set; }           // HR who last modified
    }
}
