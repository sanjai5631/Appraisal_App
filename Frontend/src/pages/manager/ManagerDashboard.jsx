...
const ManagerDashboard = () => {
  ...
  const apiUrl = `https://localhost:7098/api/SelfAppraisal/GetEmployeeById?employeeId=${employeeId}`;
          ...
          <CardWrapper
            ...
            header={
              <div className="d-flex align-items-center">
                ...
                <h4 className="mb-0 text-dark">Manager Dashboard</h4>
              </div>
            }
          >
            {/* --- Stats Section --- */}
              ...
              <Col md={4} sm={6} className="mb-3">
                <Card className="shadow text-center py-3">
                  ...
                  <Card.Body>
                    ...
                    <ProgressBar
                      now={(stats.pendingAppraisals / stats.teamReports) * 100 || 0}
                      variant="warning"
                      className="mt-2"
                    />
                  </Card.Body>
              ...
              <Col md={4} sm={6} className="mb-3">
                <Card className="shadow text-center py-3">
                  ...
                  <Card.Body>
                    ...
                    <ProgressBar
                      now={(stats.completedAppraisals / stats.teamReports) * 100 || 0}
                      variant="success"
                      className="mt-2"
                    />
                  </Card.Body>
